...
export const sounds = {
  ...
  hover0: { howl: new Howl({ src: [soundHover0], loop: false, volume: 0.08, preload: false }) },
  hover1: { howl: new Howl({ src: [soundHover1], loop: false, volume: 0.08, preload: false }) },
  hover2: { howl: new Howl({ src: [soundHover2], loop: false, volume: 0.08, preload: false }) },
  hover3: { howl: new Howl({ src: [soundHover3], loop: false, volume: 0.08, preload: false }) },
